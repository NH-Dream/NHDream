...
import { SavingList } from "../../../services/saving"
...
export default function SavingMainCardComponent() {
        ...
        <div className="collapse-title pr-3 text-xl font-medium middleText flex justify-between">
          <div className="flex flex-col whiteColor">
            ...
            {openId !== product.id && <div className="mt-3">
              최고 이자율 <span className="largeText">{Math.floor((product.maxInterestRate)*10000)/100}</span>%
            </div>}
          </div>
          <div>
        ...
        <div className="collapse-content">
          <div className="flex">
            ...
            <div className="flex flex-col whiteColor items-center justify-center ml-2">
              ...
              <div>
                최대금액 <span className="largeText">{makeMoney(product.maxMonthlyLimit)}</span>원
              </div>
              <div>
                최고 연(12개월) <span className="largeText">{Math.floor((product.maxInterestRate)*10000)/100}%</span>
              </div>
            </div>
          </div>
