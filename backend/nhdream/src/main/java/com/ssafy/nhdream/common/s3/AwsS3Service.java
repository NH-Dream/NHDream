...
import com.ssafy.nhdream.common.utils.AwsS3fileUtils;
...
public class AwsS3Service {
    ...
    public String uploadFile(MultipartFile multipartFile) {
        ...
        // S3에 저장할 파일이름으로 변환
        String fileName = AwsS3fileUtils.buildFileName(multipartFile.getOriginalFilename());
